...
#region controlsurfaces
        ...
        private void UpdateControlSurfaces()
        {
            ...
            startChord = (100 - double.Parse(cstartChordTextBox.TextBoxText))/100;
            endChord = (100 - double.Parse(cendChordTextBox.TextBoxText))/100;
            startGain = double.Parse(cstartGainTextBox.TextBoxText);
            endGain = double.Parse(cendGainTextBox.TextBoxText);
